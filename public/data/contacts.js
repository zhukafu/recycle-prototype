...
(function () {
  ...
  const PRODUCTS = [
    ...
    { id: 'c1', cat: 'contactor', model: '【老款】CJX2-9511', brand: '正泰', spec: 'AC380V 95A 老款设计', silver: '8.2g', price: '190.46', stock: '现货', tag: '老款', common: true,
      img: '/images/products/c01-zhengtai-cjx2-9511-old.jpg',
    ...
    { id: 'c2', cat: 'contactor', model: '【新款】CJX2-9511', brand: '正泰', spec: 'AC380V 95A 新款设计', silver: '7.5g', price: '166.64', stock: '现货', tag: '新款', common: true,
      img: '/images/products/c02-zhengtai-cjx2-9511-new.jpg',
    ...
    { id: 'c3', cat: 'contactor', model: '【老款】CJX2-9511', brand: '正泰', spec: 'AC380V 95A 工厂库存', silver: '9.0g', price: '215.88', stock: '现货', tag: '老款高银', common: true,
      img: '/images/products/c03-zhengtai-cjx2-9511-old-2.jpg',
    ...
    { id: 'c4', cat: 'contactor', model: '【老款】CJX2-8011', brand: '正泰', spec: 'AC380V 80A 老款', silver: '6.0g', price: '160.00', stock: '现货', tag: '老款', common: true,
      img: '/images/products/c04-zhengtai-cjx2-8011-old.jpg',
    ...
    { id: 'c5', cat: 'contactor', model: '【新款22年以后】CJX2-...', brand: '正泰', spec: '2022 年后新款系列', silver: '5.5g', price: '97.89', stock: '现货', tag: '22款', common: true,
      img: '/images/products/c05-zhengtai-cjx2-9511-2022-new.jpg',
    ...
    { id: 'c6', cat: 'contactor', model: '【老款22年以前】CJX2-...', brand: '正泰', spec: '2022 年前老款系列', silver: '7.0g', price: '122.25', stock: '现货', tag: '老款', common: true,
      img: '/images/products/c06-zhengtai-cjx2-9511-pre-2022.jpg',
    ...
    { id: 'c7', cat: 'contactor', model: '【铁底座】CJX2-5011', brand: '正泰', spec: 'AC380V 50A 铁底座', silver: '4.0g', price: '85.00', stock: '现货', tag: '铁底座', common: true,
      img: '/images/products/c07-zhengtai-cjx2-5011-iron-base.jpg',
    ...
    { id: 'c8', cat: 'contactor', model: '交流接触器 CJX2-1210', brand: '正泰', spec: 'AC220V 12A 3P+1NC', silver: '0.8g', price: '28.50', stock: '会员', tag: '直流接触器', common: true,
      title: '正泰交流接触器 CJX2-1210',
      subtitle: '12A 小电流规格 · 3 主触点 + 1 辅助',
      img: '/images/products/c08-zhengtai-cjx2-1210.jpg',
    ...
    { id: 'c9', cat: 'contactor', model: '41标接触器（5个）', brand: '正泰', spec: '41标 5个装', silver: '6.0g', price: '380.00', stock: '会员', tag: '钨钢类', common: true,
      title: '41 标接触器 5 个装',
      subtitle: '正泰钨钢类批量组 · 工厂直发装',
      img: '/images/products/c09-zhengtai-41std-5pcs.jpg',
    ...
    { id: 'c10', cat: 'contactor', model: '交流接触器 CJX2-1210', brand: '正泰', spec: 'AC220V 12A 钨钢类', silver: '0.9g', price: '32.80', stock: '会员', tag: '钨钢类', common: true,
      title: '正泰 CJX2-1210 钨钢版',
      subtitle: '钨钢触点 · 高耐磨长寿命',
      img: '/images/products/c10-zhengtai-contactor-w.jpg',
    ...
    { id: 'c11', cat: 'breaker', model: 'ZJW20-400A', brand: '正泰', spec: '400A 银触点专用', silver: '12.0g', price: '420.00', stock: '会员', tag: '银触点价格',
      ...
      img: '/images/products/c11-zhengtai-zjw20-400a.jpg',
    ...
    { id: 'c12', cat: 'breaker', model: '银触点价格 - 断路器', brand: '施耐德', spec: '银触点专用断路器', silver: '5.5g', price: '156.00', stock: '现货', tag: '银触点价格',
      ...
      img: '/images/products/c12-schneider-breaker-silver.jpg',
    ...
    { id: 'c13', cat: 'breaker', model: '银触点价格 - 八爪', brand: '德力西', spec: '八爪银触点结构', silver: '3.8g', price: '108.60', stock: '会员', tag: '银触点价格',
      ...
      img: '/images/products/c13-delixi-breaker-8claw.jpg',
    ...
    { id: 'c14', cat: 'breaker', model: '银触点价格 - 断路器', brand: '德力西', spec: '标准银触点断路器', silver: '4.2g', price: '115.80', stock: '会员', tag: '银触点价格',
      ...
      img: '/images/products/c14-delixi-breaker-silver-2.jpg',
    ...
    { id: 'c15', cat: 'contactor', model: '交流接触器 CJX1-0910', brand: '正泰', spec: 'AC220V 9A 银触点', silver: '1.0g', price: '38.00', stock: '现货', tag: '银触点价格',
      ...
      img: '/images/products/c15-zhengtai-cjx1-0910.jpg',
    ...
    { id: 'c29', cat: 'contactor', model: 'CJ20-100', brand: '正泰', spec: 'AC380V 100A 3P', silver: '6.5g', price: '285.00', stock: '现货', tag: 'CJ20',
      img: '/images/products/c29-zhengtai-cj20-100.png',
    ...
    { id: 'c30', cat: 'contactor', model: 'CJ20-63', brand: '正泰', spec: 'AC380V 63A 3P', silver: '4.2g', price: '185.00', stock: '现货', tag: 'CJ20',
      img: '/images/products/c30-zhengtai-cj20-63.png',
    ...
    { id: 'c31', cat: 'contactor', model: 'J20-100', brand: '正泰', spec: 'AC380V 100A J系列', silver: '5.8g', price: '215.00', stock: '现货', tag: 'J20',
      img: '/images/products/c31-zhengtai-j20-100.png',
    ...
    { id: 'c32', cat: 'contactor', model: 'J20-63', brand: '正泰', spec: 'AC380V 63A J系列', silver: '3.5g', price: '135.00', stock: '现货', tag: 'J20',
      img: '/images/products/c32-zhengtai-j20-63.png',
