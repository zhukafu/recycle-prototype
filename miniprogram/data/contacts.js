...
(function () {
  ...
  const PRODUCTS = [
    ...
    { id: 'c8', cat: 'contactor', model: '交流接触器 CJX2-1210', brand: '正泰', spec: 'AC220V 12A 3P+1NC', silver: '0.8g', price: '', stock: '会员', tag: '直流接触器',
      img: '/交流接触器CJX2-1210.jpg',
      desc: '正泰 CJX2-1210 交流接触器，AC220V/12A 小电流规格，3 主触点 + 1 辅助触点，结构紧凑，适用于小功率电机控制。需开通会员查看完整回收价。' },
    { id: 'c9', cat: 'contactor', model: '41标接触器（5个）', brand: '正泰', spec: '41标 5个装', silver: '6.0g', price: '', stock: '会员', tag: '钨钢类',
      img: '/41标接触器 5个.jpg',
      desc: '41 标接触器 5 个装批次，钨钢类材质，含银量较高，是回收商的热门品类。需开通会员查看详细价。' },
    { id: 'c10', cat: 'contactor', model: '交流接触器 CJX2-1210', brand: '正泰', spec: 'AC220V 12A 钨钢类', silver: '0.9g', price: '', stock: '会员', tag: '钨钢类',
      img: '/交流接触器.jpg',
      desc: '正泰 CJX2-1210 交流接触器，钨钢材质版本，AC220V/12A，触点耐磨、寿命长，适合高频次切换场合。' },
    { id: 'c11', cat: 'breaker', model: 'ZJW20-400A', brand: '正泰', spec: '400A 银触点专用', silver: '12.0g', price: '', stock: '会员', tag: '银触点价格',
      img: '/ZJW20-400A.jpg',
    ...
    { id: 'c13', cat: 'breaker', model: '银触点价格 - 八爪', brand: '德力西', spec: '八爪银触点结构', silver: '3.8g', price: '', stock: '会员', tag: '银触点价格',
      img: '/银触点价格 八爪...jpg',
      desc: '德力西八爪银触点结构断路器，独特的多触点设计，电流分布更均匀，含银量 3.8g，回收价需开通会员查看。' },
    { id: 'c14', cat: 'breaker', model: '银触点价格 - 断路器', brand: '德力西', spec: '标准银触点断路器', silver: '4.2g', price: '', stock: '会员', tag: '银触点价格',
      img: '/银触点价格 断路器-2.jpg',
